...
import admin_image from "../public/img/faces/avatar.jpg";
        ...
        <div className={classes.container}>
          {/* <GridContainer>
            <GridItem xs={12} sm={12} md={6}>
              <h1 className={classes.title}>Art Gallery</h1>
              <h4>
        ...
        <div>
          <div className={classes.container}>
              ...
              <GridItem xs={12} sm={12} md={6}>
                <div className={classes.profile}>
                  ...
                  <div className={classes.name}>
                    <h3 className={classes.title}>Harmeet Kaur</h3>
            ...
            <div className={classes.description}>
              <p>
                A Creative Artist by heart and a Chartered Accountant in the head, she chose to listen to her heart after ~15 years of a corporate career.
